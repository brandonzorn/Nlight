...
class RanobeLibItems(LibBaseItems):
    ...
    KINDS = [
        {"value": 10, "name": "Japan", "russian": "Япония"},
        {"value": 11, "name": "Korea", "russian": "Корея"},
        {"value": 12, "name": "China", "russian": "Китай"},
        {"value": 13, "name": "English", "russian": "Английский"},
        {"value": 14, "name": "Original", "russian": "Авторский"},
        {"value": 15, "name": "Fanfiction", "russian": "Фанфик"},
    ]

...
class Ui_ReaderWindow(object):
    def setupUi(self, ReaderWindow):
        ...
        sizePolicy.setHeightForWidth(
            self.reader_widget.sizePolicy().hasHeightForWidth()
        )
        ...
        sizePolicy1.setHeightForWidth(
            self.actions_frame.sizePolicy().hasHeightForWidth()
        )
        ...
        sizePolicy2.setHeightForWidth(
            self.prev_chapter_btn.sizePolicy().hasHeightForWidth()
        )
        ...
        sizePolicy2.setHeightForWidth(
            self.prev_page_btn.sizePolicy().hasHeightForWidth()
        )
        ...
        sizePolicy2.setHeightForWidth(
            self.next_page_btn.sizePolicy().hasHeightForWidth()
        )
        ...
        sizePolicy2.setHeightForWidth(
            self.next_chapter_btn.sizePolicy().hasHeightForWidth()
        )
        ...
        sizePolicy2.setHeightForWidth(
            self.fullscreen_btn.sizePolicy().hasHeightForWidth()
        )
        ...
        sizePolicy2.setHeightForWidth(
            self.ch_list_btn.sizePolicy().hasHeightForWidth()
        )
        ...
        sizePolicy3.setHeightForWidth(
            self.chapters_frame.sizePolicy().hasHeightForWidth()
        )
    ...
    def retranslateUi(self, ReaderWindow):
        ReaderWindow.setWindowTitle(
            QCoreApplication.translate("ReaderWindow", "MainWindow", None)
        )
        self.prev_chapter_btn.setText("")
        # if QT_CONFIG(shortcut)
        self.prev_chapter_btn.setShortcut(
            QCoreApplication.translate("ReaderWindow", "Down", None)
        )
        # endif // QT_CONFIG(shortcut)
        self.prev_page_btn.setText("")
        # if QT_CONFIG(shortcut)
        self.prev_page_btn.setShortcut(
            QCoreApplication.translate("ReaderWindow", "Left", None)
        )
        # endif // QT_CONFIG(shortcut)
        self.chapter_label.setText(
            QCoreApplication.translate(
                "ReaderWindow", "\u0413\u043b\u0430\u0432\u0430 1", None
            )
        )
        ...
        # if QT_CONFIG(shortcut)
        self.next_page_btn.setShortcut(
            QCoreApplication.translate("ReaderWindow", "Right", None)
        )
        # endif // QT_CONFIG(shortcut)
        self.next_chapter_btn.setText("")
        # if QT_CONFIG(shortcut)
        self.next_chapter_btn.setShortcut(
            QCoreApplication.translate("ReaderWindow", "Up", None)
        )
        # endif // QT_CONFIG(shortcut)
        self.fullscreen_btn.setText("")
        # if QT_CONFIG(shortcut)
        self.fullscreen_btn.setShortcut(
            QCoreApplication.translate("ReaderWindow", "F11", None)
        )
        # endif // QT_CONFIG(shortcut)
        self.ch_list_btn.setText("")
        # if QT_CONFIG(shortcut)
        self.ch_list_btn.setShortcut(
            QCoreApplication.translate("ReaderWindow", "C", None)
        )

...
class Ui_ReaderWindow(object):
    def setupUi(self, ReaderWindow):
        ...
        self.reader_frame = QFrame(self.widget)
        self.reader_frame.setObjectName(u"reader_frame")
        sizePolicy.setHeightForWidth(self.reader_frame.sizePolicy().hasHeightForWidth())
        self.reader_frame.setSizePolicy(sizePolicy)
        self.reader_frame.setFrameShape(QFrame.StyledPanel)
        self.reader_frame.setFrameShadow(QFrame.Raised)
        self.reader_layout = QHBoxLayout(self.reader_frame)
        self.reader_layout.setObjectName(u"reader_layout")

        self.verticalLayout_3.addWidget(self.reader_frame)

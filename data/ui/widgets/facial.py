...
class Ui_Form(object):
    ...
    def retranslateUi(self, Form):
        ...
        self.filter_btn.setText(QCoreApplication.translate("Form", "Filters", None))
        ...
        self.genres_btn.setText(QCoreApplication.translate("Form", "Genres list", None))
        self.catalogs_btn.setText(QCoreApplication.translate("Form", "Catalogs", None))
        self.reset_btn.setText(QCoreApplication.translate("Form", "Reset", None))
        self.apply_btn.setText(QCoreApplication.translate("Form", "Apply", None))
        pass

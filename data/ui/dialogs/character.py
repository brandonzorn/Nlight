...
class Ui_Dialog(object):
    ...
    def retranslateUi(self, Dialog):
        ...
        self.russian_label.setText(
            QCoreApplication.translate("Dialog", "russian", None)
        )
        self.show_spoilers.setText(
            QCoreApplication.translate("Dialog", "Show spoilers", None)
        )
        pass

...
class Ui_Dialog(object):
    ...
    def retranslateUi(self, Dialog):
        ...
        self.show_spoilers.setOnText(QCoreApplication.translate("Dialog", u"Show spoilers", None))
        self.show_spoilers.setOffText(QCoreApplication.translate("Dialog", u"Show spoilers", None))
        pass
    # retranslateUi

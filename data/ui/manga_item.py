...
class Ui_manga_item_widget(object):
    def setupUi(self, manga_item_widget):
        if not manga_item_widget.objectName():
            manga_item_widget.setObjectName("manga_item_widget")
        manga_item_widget.resize(485, 406)
        sizePolicy = QSizePolicy(QSizePolicy.Minimum, QSizePolicy.Minimum)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(
            manga_item_widget.sizePolicy().hasHeightForWidth()
        )
        manga_item_widget.setSizePolicy(sizePolicy)
        manga_item_widget.setStyleSheet("")
        self.verticalLayout = QVBoxLayout(manga_item_widget)
        self.verticalLayout.setObjectName("verticalLayout")
        self.verticalLayout.setContentsMargins(0, 0, 0, 0)
        self.manga_item_frame = QFrame(manga_item_widget)
        self.manga_item_frame.setObjectName("manga_item_frame")
        sizePolicy.setHeightForWidth(
            self.manga_item_frame.sizePolicy().hasHeightForWidth()
        )
        ...
        self.manga_item_frame.setStyleSheet("")
    ...
    def retranslateUi(self, manga_item_widget):
        manga_item_widget.setWindowTitle(
            QCoreApplication.translate("manga_item_widget", "Form", None)
        )
        self.image.setText("")
